"""
Django settings for ITADS project.
...
SECRET_KEY = 'django-insecure-hb_%yz6-h8!uo=7!201t)%)r^8em@wl+x3e)z*j#gc#-#a_#qn'
...
INSTALLED_APPS = [
    ...
    'django.contrib.sitemaps', # Custom app for API
]
...
ROOT_URLCONF = 'ITADS.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        # Added frontend as template directory
...
WSGI_APPLICATION = 'ITADS.wsgi.application'
